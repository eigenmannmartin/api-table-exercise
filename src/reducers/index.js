...
const reducerFactory = ([REQUEST, SUCCESS, FAILURE], norm = identity) => (
...
export default combineReducers({
  page,
  posts: reducerFactory([POSTS_REQUEST, POSTS_SUCCESS, POSTS_FAILURE], data =>
    path(["entities", "posts"], normalize(data, [post]))
  ),
  users: reducerFactory([USERS_REQUEST, USERS_SUCCESS, USERS_FAILURE], data =>
    path(["entities", "users"], normalize(data, [user]))
  ),
